...
objets \ref{conan2015introduction}.
...
\subsubsection{Manipulation des données de la base}
    ...
    \paragraph{}
    Ce diagramme montre les relations entre des objets à travers 
    ...
    \end{itemize}
    Le diagramme de classes modélise les règles et le diagramme d'objets modélise des faits \ref{audibert2009uml}.