...
\subsubsection{Parcourir le Webmap}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{images/Analyse_des_besoins/parcourirLeWebmap.jpg}
        \caption{Diagramme des cas d'utilisation: parcourir le webmap}
    \end{figure}
\par 
...
\subsubsection{Manipulation des données de la base}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{images/Analyse_des_besoins/manipulationDesDonneesDeLaBase.jpg}
        \caption{Diagramme des cas d'utilisation: Gestion des données liées aux essais géotechniques}
    \end{figure}
    \par 
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[width=1\textwidth]{images/Analyse_des_besoins/ClassDiagram.jpg}
    ...
    montre les actions à un très haut niveau d’abstraction avec les interactions entre elles \cite{conan}. 
    ...
    \begin{figure}[t]
        ...
        \caption{Diagramme des séquences : gestion des ressources par l'administrateur}
    ...
    \begin{figure}[t]
        ...
        \caption{Diagramme des séquences : visiteur utilisant le webmap}
