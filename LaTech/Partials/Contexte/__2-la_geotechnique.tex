...
\paragraph{}
Vulgairement appelé \textit{Goudougoudou}, un séisme de magnitude 7 sur l'échelle de Richter, 
...
\textit{
    ...
    \end{figure}
Les images \ref{fig:musseau1} et \ref{fig:musseau2} sont une représentation typique
...
\begin{figure}
    ...
    \begin{subfigure}{.45\linewidth}
        \includegraphics[scale=0.35]{images/Contexte/musseau1.png}
        \caption{Glissement de terrain à Musseau (photo Le Nouvelliste)}
        \label{fig:musseau1}
    \end{subfigure}
    \hskip0.1em
    \begin{subfigure}{.46\linewidth}
        \includegraphics[scale=0.35]{images/Contexte/musseau2.png}
        \caption{Zoom sur l'éfondrement d'une partie de la maison}
        \label{fig:musseau2}
    \end{subfigure}
\end{figure} 
